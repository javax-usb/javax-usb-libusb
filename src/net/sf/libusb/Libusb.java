...
public class Libusb implements LibusbConstants {
  public static SWIGTYPE_p_usb_dev_handle usb_open(usb_device dev) {
    long cPtr = LibusbJNI.usb_open(usb_device.getCPtr(dev), dev);
  ...
  public static int usb_claim_interface(SWIGTYPE_p_usb_dev_handle dev, int arg1) {
    return LibusbJNI.usb_claim_interface(SWIGTYPE_p_usb_dev_handle.getCPtr(dev), arg1);
  }

  public static int usb_release_interface(SWIGTYPE_p_usb_dev_handle dev, int arg1) {
    return LibusbJNI.usb_release_interface(SWIGTYPE_p_usb_dev_handle.getCPtr(dev), arg1);
  }
  ...
  public static usb_interface usb_interface_index(usb_interface iface, long index) {
    long cPtr = LibusbJNI.usb_interface_index(usb_interface.getCPtr(iface), iface, index);
    return (cPtr == 0) ? null : new usb_interface(cPtr, false);
  }

  public static usb_device usb_device_index(usb_device dev, long index) {
    long cPtr = LibusbJNI.usb_device_index(usb_device.getCPtr(dev), dev, index);
    return (cPtr == 0) ? null : new usb_device(cPtr, false);
  }

  public static usb_endpoint_descriptor usb_endpoint_descriptor_index(usb_endpoint_descriptor ep, long index) {
    long cPtr = LibusbJNI.usb_endpoint_descriptor_index(usb_endpoint_descriptor.getCPtr(ep), ep, index);
  ...
  public static usb_config_descriptor usb_config_descriptor_index(usb_config_descriptor dev, long index) {
    long cPtr = LibusbJNI.usb_config_descriptor_index(usb_config_descriptor.getCPtr(dev), dev, index);
  ...
  public static usb_interface_descriptor usb_interface_descriptor_index(usb_interface_descriptor iface_desc, long index) {
    long cPtr = LibusbJNI.usb_interface_descriptor_index(usb_interface_descriptor.getCPtr(iface_desc), iface_desc, index);
